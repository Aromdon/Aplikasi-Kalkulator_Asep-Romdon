package com.romdon.aplikasikalkulator_asepromdon;
...
public class MainActivity extends AppCompatActivity {
   // Mendeklarasikan Varible
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Memanggil varible berdasarkan id nya
        ...
        kurang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ((angka_pertama.getText().length()>0) && (angka_kedua.getText().length()>0))
                {
                    ...
                    Toast toast = Toast.makeText(MainActivity.this, "Mohon masukan angka pertama dam kedua", Toast.LENGTH_LONG);
                    toast.show();
                }
            }
        });
